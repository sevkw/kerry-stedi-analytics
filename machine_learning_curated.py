...
StepTrainerTrusted_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://kerry-pj3-stedi-lakehouse/step_trainer/trusted/"],
        "recurse": True,
    },
...
AccelerometerTrusted_node1677211516686 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://kerry-pj3-stedi-lakehouse/accelerometer/trusted/"],
        "recurse": True,
    },
...
DistinctUserEmail_node1677211642582 = DynamicFrame.fromDF(
...
MachineLearningCurated_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://kerry-pj3-stedi-lakehouse/step_trainer/machine_learning_curated/",
        "partitionKeys": [],
    },
